 ...
 */
@Ignore
final class MinimaxDoublePolynomialApproxExecutorBehaviorTest {

    private final DoubleApproxTarget target;

    public static void main(String[] args) {
        new MinimaxDoublePolynomialApproxExecutorBehaviorTest().execute();
    }

    MinimaxDoublePolynomialApproxExecutorBehaviorTest() {
        this.target = exp();
    }
