...
/**
 * {@link Decimal128} クラスのテスト.
 */
@RunWith(Enclosed.class)
final class Decimal128Test {
    public static final Class<?> TEST_CLASS = Decimal128.class;

    private static final TypeProvider<Decimal128> ELEMENT_PROVIDER = Decimal128.elementTypeProvider();
    ...
    public static class 二項演算のテスト_特殊値 {
        ...
        @Test(expected = None.class)
        public void test_doubleMaxでの和() {
            ELEMENT_PROVIDER.fromDoubleValue(Double.MAX_VALUE).plus(Double.MAX_VALUE);
        }

        @Test(expected = None.class)
        public void test_doubleMaxでの差() {
            ELEMENT_PROVIDER.fromDoubleValue(Double.MAX_VALUE).minus(-Double.MAX_VALUE);
        }

        @Test(expected = None.class)
        public void test_doubleMaxでの積() {
            ELEMENT_PROVIDER.fromDoubleValue(Double.MAX_VALUE).times(Double.MAX_VALUE);
        }

        @Test(expected = None.class)
        public void test_doubleMax_Minでの商() {
            ELEMENT_PROVIDER.fromDoubleValue(Double.MAX_VALUE).dividedBy(Double.MAX_VALUE);
        }
