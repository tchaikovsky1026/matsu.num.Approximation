...
public class NodeAddableNewtonPolynomialTest {
    ...
    private NodeAddableNewtonPolynomial polynomial;
    ...
    public void createPolynomial() {
        ...
        polynomial = new NodeAddableNewtonPolynomial();
        for (int i = 0; i < thisSize; i++) {
            polynomial.addCrossPoint(node[i], value[i]);
        }
    }

    @Test
    public void testAddCrossPoint() {
        //省略
    }
    ...
    public void testClear() {
        polynomial.clear();
        NodeAddableNewtonPolynomial tempStoredPolynomial = polynomial;
        createPolynomial();
        polynomial = tempStoredPolynomial;
        for (int i = 0; i < size; i++) {
            polynomial.addCrossPoint(node[i], value[i]);
        }
        testValue();
        testGetPolynomialCoefficient();
    }
